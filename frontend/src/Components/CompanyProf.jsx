...
const CompanyProf = () => {
  ...
  const handleReviewSubmit = (e) => {
    ...
    localStorage.setItem(`companyReviews_${company.id}`, JSON.stringify(updatedReviews));
    setRating(0);
    setHover(0);
    setComment('');
  ...
  if (!company) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-teal-50 to-gray-100 flex items-center justify-center">
        <p className="text-teal-800 text-lg">No company profile found. Please create one first.</p>
      </div>
    );
  }
