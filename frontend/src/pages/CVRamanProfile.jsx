...
function CVRamanProfile() {
  const company = {
    name: 'CV Raman',
    logo: 'https://images.unsplash.com/photo-1599305445671-744b03b3e6e2?q=80&w=2070&auto=format&fit=crop', // Placeholder logo
    industry: 'Education',
    location: 'Bangalore, India',
    establishedDate: '2000-01-15',
    employeeCount: 150,
    website: 'https://cvraman.com',
    description: 'CV Raman is a leading educational institution focused on science and technology education.',
  };

  const [reviews, setReviews] = useState([
    { _id: '1', userName: 'John Doe', rating: 4.5, comment: 'Great place to work, excellent learning environment!', createdAt: '2024-10-01' },
    { _id: '2', userName: 'Jane Smith', rating: 5, comment: 'Inspiring leadership and supportive team.', createdAt: '2024-09-15' },
  ]);
