...
function DataWorksProfile() {
  const company = {
    ...
    establishedDate: '2015-07-10',
    employeeCount: 200,
    website: 'https://dataworks.com',
    description: 'DataWorks provides cutting-edge data analytics and AI solutions for businesses.',
  };
...
export default DataWorksProfile;